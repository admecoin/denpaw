...
use Denpaw\Playcoin\Exceptions\BadRemoteCallException;
use Denpaw\Playcoin\Traits\HandlesAsync;
...
class Client
{
    ...
    /**
     * Makes request to Playcoin Core.
     *
     * @param string $method
     * @param mixed  $params
     *
    ...
    /**
     * Makes async request to Playcoin Core.
     *
     * @param string        $method
     * @param mixed         $params
    ...
    {
        return 'Denpaw\\Playcoin\\Responses\\PlaycoindResponse';
    }
