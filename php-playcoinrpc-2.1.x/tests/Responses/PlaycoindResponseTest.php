...
namespace Denpaw\Playcoin\Tests\Responses;
...
class PlaycoindResponseTest extends TestCase
{
    /**
     * Set up test.
     *
    ...
    public function setUp(): void
    {
        ...
        $this->response = new PlaycoindResponse($this->guzzleResponse);
    ...
    {
        $response = new PlaycoindResponse($this->rawTransactionError());
    ...
    public function testSerialize(): void
    {
        ...
        $serialized = sprintf(
            'C:%u:"%s":%u:{%s}',
            strlen(PlaycoindResponse::class),
            PlaycoindResponse::class,
